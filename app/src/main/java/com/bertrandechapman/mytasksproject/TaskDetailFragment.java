...
public class TaskDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        task = getArguments().getParcelable(TaskDetailFragment.PARCELABLE_KEY);

        Log.i("Parcel", task.toString());

        // Inflate the layout for this fragment
        View fragmentView = inflater.inflate(R.layout.fragment_task_detail, container, false);

        TextView txtTitle = fragmentView.findViewById(R.id.txtTitle);
        txtTitle.setText(task.getTitle());

        TextView txtDesc = fragmentView.findViewById(R.id.txtDesc);
